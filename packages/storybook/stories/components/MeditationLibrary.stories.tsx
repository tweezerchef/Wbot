...
import { MeditationCard, MeditationLibrary } from '@/components/MeditationLibrary';
 ...
 */
const cardMeta: Meta<typeof MeditationCard> = {
...
type CardStory = StoryObj<typeof MeditationCard>;
 ...
 */
export const FavoritedCard: CardStory = {
  args: {
 ...
 */
export const SleepMeditationCard: CardStory = {
  args: {
 ...
 */
export const FrequentlyPlayedCard: CardStory = {
  args: {
 ...
 */
const libraryMeta: Meta<typeof MeditationLibrary> = {
...
export { libraryMeta };
type LibraryStory = StoryObj<typeof MeditationLibrary>;

/**
 * Default library view with meditations
 *
 * Note: This story shows the library UI structure. In production,
 * the hook would fetch real data from Supabase.
 */
export const DefaultLibrary: LibraryStory = {
  parameters: {
    docs: {
      description: {
        story:
          'Default library view. Note: In Storybook, this shows the loading state since no data provider is mocked.',
      },
    },
  },
};
 ...
 */
export const CompactLibrary: LibraryStory = {
  args: {
    compact: true,
    maxItems: 3,
  },
 ...
 */
export const FavoritesOnly: LibraryStory = {
  args: {
    initialFilters: {
      favoritesOnly: true,
    },
 ...
 */
export const FilteredByType: LibraryStory = {
  args: {
    initialFilters: {
      type: 'body_scan',
    },
 ...
 * Mobile viewport
 */
export const MobileLibrary: LibraryStory = {
  parameters: {
    viewport: {
