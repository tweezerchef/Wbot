...
vi.mock('@/features/breathing/hooks/useBreathingLoop', () => ({
...
vi.mock('@/features/breathing/hooks/useBreathingAudio', () => ({
  useBreathingAudio: vi.fn(() => mockAudioControls),
}));

// Mock the haptic feedback hook
vi.mock('@/features/breathing/hooks/useHapticFeedback', () => ({
...
describe('ImmersiveBreathing', () => {
  ...
  describe('completion state', () => {
    it('shows completion screen when exercise is complete', async () => {
      ...
      const { useBreathingLoop } = await import('@/features/breathing/hooks/useBreathingLoop');
