/* ============================================================================
   ...
   ============================================================================
   Consolidated type definitions for the wellness feature.
   ============================================================================ */

import type { Tables, MoodRating } from '@wbot/shared';

// Re-export MoodRating from shared for convenience
...
/** Props for the MoodCheck component */
